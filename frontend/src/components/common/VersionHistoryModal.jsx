                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '15px' }}>
                                        ...
                                        <div className="submission-actions">
                                            {sub.submissionType === 'link' ? (
                                                ...
                                                <a href={`${API_BASE_URL}${sub.fileUrl}`} target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-outline-primary" style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
