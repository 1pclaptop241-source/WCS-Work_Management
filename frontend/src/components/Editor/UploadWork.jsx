          ...
          {project.scriptFile && (
            <div className="client-script-section" style={{
              ...
              <div style={{
                ...
                <a
                  href={`${API_BASE_URL}${project.scriptFile}`}
                  target="_blank"
                          ...
                          <li key={idx} className={corr.done ? 'correction-done' : 'correction-pending'}>
                            ...
                            {corr.voiceFile && (
                              <div style={{ marginTop: '8px', marginBottom: '8px' }}>
                                ...
                                <audio controls src={`${API_BASE_URL}${corr.voiceFile}`} style={{ display: 'block', width: '100%', maxWidth: '400px' }} />
                              </div>
                            )}
                              ...
                              <div style={{ marginTop: '8px' }}>
                                ...
                                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                                  {corr.mediaFiles.map((m, idx) => (
                                    <a key={idx} href={`${API_BASE_URL}${m}`} target="_blank" rel="noopener noreferrer" style={{ fontSize: '13px', color: '#06A77D', textDecoration: 'none', padding: '6px 12px', background: '#e8f5f1', borderRadius: '6px', border: '1px solid #06A77D', fontWeight: '500' }}>
                                      📄 File {idx + 1}
                                    </a>
                                  ))}
                                </div>
