    ...
    return (
        <div className="container max-w-[1400px] py-6 space-y-6">
            <div className="flex items-center gap-4">
                ...
                <h1 className="text-2xl font-bold tracking-tight">Upload Work: {workBreakdown.workType || 'Unknown Type'}</h1>
            </div>

            <ErrorBoundary fallbackMessage="Failed to load upload page content.">
                            ...
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        ...
                                        <div className="font-medium">{workBreakdown.project?.title || 'Unknown Project'}</div>
                                    </div>
                                    <div className="space-y-1">
                                            ...
                                            {workBreakdown.feedback.map((f, i) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex items-center gap-2 mt-1 px-1">
                                                        ...
                                                        <span className="text-xs text-muted-foreground">{formatDateTime(f.timestamp)}</span>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
